...
tic
% read polarization images from database (4 RGB pics)
...
origin = cat(3,I0,I45,I90,I135);
%% caculate Stokes parameters of Origin Image 
...
mosaic(:,:,1) = origin(:,:,1) .* mask_0;
mosaic(:,:,2) = origin(:,:,2) .* mask_45;
mosaic(:,:,3) = origin(:,:,3) .* mask_90;
mosaic(:,:,4) = origin(:,:,4) .* mask_135;


%% get the Demosaic Image: demosaic (I0_d,I45_d,I90_d,I135_d)
I=sum(mosaic,3);
[I0_d,I45_d,I90_d,I135_d] = Newton_Polynomial_Interpolation(I);
toc
t=toc;
